---
name: shell-builtins
description: Use when creating a new shell builtin command for Harness (internal/shell/), editing an existing one, or when the user needs to understand how commands are intercepted in Harness's embedded shell.
---

# Shell Builtins

Harness's shell (`internal/shell/`) uses `mvdan.cc/sh/v3` for POSIX shell
