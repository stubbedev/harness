...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/workspaces/{id}/extensions/commands": {
            "get": {
                "produces": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/proto.ExtensionCommandInfo"
                            }
                        }
                    },
                    "404": {
        ...
        "/workspaces/{id}/extensions/commands/run": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "description": "Run extension command request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/proto.RunExtensionCommandRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/proto.RunExtensionCommandResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "proto.ExtensionCommandInfo": {
            "type": "object",
            "properties": {
                "arguments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/proto.ExtensionCommandArgument"
                    }
                },
                "description": {
                    "type": "string"
        ...
        "proto.RunExtensionCommandRequest": {
            "type": "object",
            "properties": {
                "arguments": {
                    "type": "object",
        ...
        "proto.RunExtensionCommandResponse": {
            "type": "object",
            "properties": {
                "prompt": {
                    "type": "string"
