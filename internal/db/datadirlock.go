...
// already in use by another harness process.
var ErrDataDirLocked = errors.New("data directory already in use by another harness process")

// dataDirLockFile is the name of the lock file inside the data
// directory. It lives next to harness.db so users can `ls` and find it.
