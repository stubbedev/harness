...
func createTestLogFile(t *testing.T, entries []map[string]any) string {
	t.Helper()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "harness.log")
...
func TestHarnessLogs_HappyPath(t *testing.T) {
	...
	result := runHarnessLogs(logFile, HarnessLogsParams{Lines: 3})
...
func TestHarnessLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runHarnessLogs(logFile, HarnessLogsParams{Lines: 0})
...
func TestHarnessLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runHarnessLogs(logFile, HarnessLogsParams{Lines: 200})

	lines := strings.Split(result, "\n")
	require.Len(t, lines, 100)
}

func TestHarnessLogs_MissingFile(t *testing.T) {
	t.Parallel()
	result := runHarnessLogs("/nonexistent/path/harness.log", HarnessLogsParams{Lines: 50})
	require.Contains(t, result, "No log file found")
}

func TestHarnessLogs_EmptyFile(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "harness.log")
	...
	result := runHarnessLogs(logFile, HarnessLogsParams{Lines: 50})
	require.Contains(t, result, "Log file is empty")
}

func TestHarnessLogs_MalformedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "harness.log")
	...
	result := runHarnessLogs(logFile, HarnessLogsParams{Lines: 10})
...
func TestHarnessLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runHarnessLogs(logFile, HarnessLogsParams{Lines: 1})
...
func TestHarnessLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestHarnessLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestHarnessLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestHarnessLogs_OversizedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "harness.log")
...
func TestHarnessLogs_PartialTrailingLine(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "harness.log")
...
func TestHarnessLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestHarnessLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestHarnessLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestHarnessLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runHarnessLogs(logFile, HarnessLogsParams{Lines: 5})
...
func TestHarnessLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
