...
//go:embed templates/fast.md.tpl
var fastPromptTmpl []byte
...
func fastPrompt(opts ...prompt.Option) (*prompt.Prompt, error) {
	systemPrompt, err := prompt.NewPrompt("fast", string(fastPromptTmpl), opts...)
	if err != nil {
		return nil, err
	}
	return systemPrompt, nil
