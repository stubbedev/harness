...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View harness logs",
	Long:  `View the logs generated by Harness. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a harness project. No logs found.")
			return nil
		}
