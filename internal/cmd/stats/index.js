// Get the theme colors once from computed styles
const rootStyles = getComputedStyle(document.documentElement);
const colors = {
	accent: rootStyles.getPropertyValue('--accent').trim(),
	text: rootStyles.getPropertyValue('--text').trim(),
	muted: rootStyles.getPropertyValue('--text-muted').trim(),
	chart1: rootStyles.getPropertyValue('--chart-1').trim(),
	chart2: rootStyles.getPropertyValue('--chart-2').trim(),
	chart3: rootStyles.getPropertyValue('--chart-3').trim(),
	chart4: rootStyles.getPropertyValue('--chart-4').trim(),
	chart5: rootStyles.getPropertyValue('--chart-5').trim(),
	chart6: rootStyles.getPropertyValue('--chart-6').trim(),
};
...
// Ramps from the dimmest chart gray up to the accent color.
const lowColor = hexToRgb(colors.chart5);
const highColor = hexToRgb(colors.accent);
		...
		datasets: [
			{
				...
				backgroundColor: [colors.accent, colors.chart4],
				borderWidth: 0,
			},
		],
	},
